...
$(function(){
	...
	$form.on("change","input:file",function(){
		...
		$this.closest('form').ajaxSubmit({
			...
			url: "/schoollife/admin/index.php/home"+'/Common/ajaximg',
			type:'POST',
			data:data,
			dataType: 'json',
			async:false,
...
<form id="Formid" name="myForm" action="/schoollife/admin/index.php/home/Common/edit/table/message_2/id/<?php echo $_GET['cid'];?>" method="post">
	<div id="container">
