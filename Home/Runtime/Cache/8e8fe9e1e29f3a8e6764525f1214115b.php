...
<div id="body">
    ...
    <div class="part_add">
      ...
      <div class="menu_more">
        <a href="__APP__/Message"><div style="position:relative;top:-35px;" class="part_add_button" id="part_add_button">发布</div></a>
        <div class="menu">
...
<!--。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。-->
      ...
      <div class="new_tittle"><h2>最新二手信息</h5> </div>
      ...
      <div class="new">
        <ul>
          ...
          <li class="new_li">
            ...
            <nobr><small><?php echo ($vo['span_2']); ?>&nbsp<?php echo (subtext($vo['span_3'],8)); ?><br>电话:<?php echo (subtext($vo["tel"],11)); ?> QQ:<?php echo (subtext($vo["qq"],11)); ?><br><br></small></nobr>
      ...
      <div class="new_tittle"><h2>最新寻物启事</h2></div>
      <center>
      <div class="new">
        <ul>
          <?php if(is_array($data2)): $i = 0; $__LIST__ = $data2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="__URL__/message_more/id/<?php echo ($vo["id"]); ?>"><li class="new_li">
          <img onerror="this.src='__IMAGES__/img_error.png'" src="__UPLOADS__/thumb_<?php echo ($vo['image']); ?>">
          <h3><?php echo (subtext($vo['message_tittle'],5)); ?></h3>
      ...
      <div class="new_tittle"><h2>最新失物招领</h2></div>
      <center>
      <div class="new">
        <ul>
          <?php if(is_array($data3)): $i = 0; $__LIST__ = $data3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="__URL__/message_more/id/<?php echo ($vo["id"]); ?>"><li class="new_li"> 
          <img onerror="this.src='__IMAGES__/img_error.png'" src="__UPLOADS__/thumb_<?php echo ($vo['image']); ?>">
     <h3><?php echo (subtext($vo['message_tittle'],5)); ?></h3>
          <nobr><small><?php echo (subtext($vo['span_2'],15)); ?><br>电话:<?php echo (subtext($vo["tel"],11)); ?> QQ:<?php echo (subtext($vo["qq"],11)); ?><br><br></small></nobr>
             <div style="width:100%; border-bottom:1px solid #006B6B;"></div> 
        ...
        <a href="__URL__/lose">更多失物招领>></a>
      </div>
      </center>


      <div class="new_tittle"><h2>最新其他信息</h2></div>  
      <center>
      <div class="new">
        <ul>
          <?php if(is_array($data4)): $i = 0; $__LIST__ = $data4;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="__URL__/message_more/id/<?php echo ($vo["id"]); ?>"><li class="new_li">
          <img onerror="this.src='__IMAGES__/img_error.png'" src="__UPLOADS__/thumb_<?php echo ($vo['image']); ?>">
   <h3><?php echo (subtext($vo['message_tittle'],5)); ?></h3>
          <nobr><small><?php echo (subtext($vo['span_2'],15)); ?><br>电话:<?php echo (subtext($vo["tel"],11)); ?> QQ:<?php echo (subtext($vo["qq"],11)); ?><br><br></small></nobr>
             <div style="width:100%; border-bottom:1px solid #006B6B;"></div> 
